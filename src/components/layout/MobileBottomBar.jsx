  ...
  return (
    <div className="mobile-bottom-bar">
      <div className="mobile-bottom-bar-inner">
        <div className="mbb-secondary-actions">
          <a href={`tel:${contact.primaryPhone}`} className="mbb-icon-btn">
          ...
          {conversation.whatsappEnabled && (
            <a href={waLink} target="_blank" rel="noopener noreferrer" className="mbb-icon-btn whatsapp">
        ...
        <Link to="/contact" className="mbb-btn-primary">Book Consult</Link>
      </div>
    </div>
  );
}
